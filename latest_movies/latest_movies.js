    ...
    HightRatedMovie.then(
       (movies) => {
        movies.forEach((movie) => {
            ...
            setAttributes(movieDiv, {"class": "card d-flex justify-content-center align-items-center col-sm-4 col-md-2 mx-1 border border-dark slider bg-dark text-white pt-3 pb-1 mb-2 hover-box"});
